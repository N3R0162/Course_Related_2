...
# WFLW, mobilenet_v2
# python lib/test.py experiments/WFLW/pip_32_16_60_mbv2_l2_l1_10_1_nb10.py test.txt images_test
#WFLW, mobilenet_v3
# python lib/test.py experiments/WFLW/pip_32_16_60_mbv3large_l2_l1_10_1_nb10.py test.txt images_test

# Iris, resnet18
# python lib/test.py experiments/Iris/pip_32_16_60_r18_l2_l1_10_1_nb10.py test.txt images_test
...
# LaPa, resnet18
# python lib/test.py experiments/LaPa/pip_32_16_60_r18_l2_l1_10_1_nb10.py test.txt images_test
######################################################################################
# GSSL
